...
function OurMission() {
  return (
    <div>
      <h1 className='text-blue-700 font-bold'>RCJC MISSION STATEMENT</h1>
      <p className='pt-5 text-blue-400'><b>1.</b> Proclaiming salvation and repentance through preaching, 
        <br />teaching, and sharing God's message.</p>
        ...
        <br /> then send them out to fulfill God's Great Commission</p>
